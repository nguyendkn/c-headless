...
import { IconMouse, IconMouseTool } from '@/components/icons/icon-mouse';
import { IconPad, IconPadTool } from '@/components/icons/icon-pad';
...
const InteractiveItem: React.FC<{
  ...
  >
    <div
      className={`mouse-pad-option-icon ${selected ? 'mouse-pad-option-icon-selected' : ''}`}
    >
      {icon}
    </div>
    <Title
