...
export class WorkflowRuntimeServerClient implements IRuntimeClient {
  ...
  public async [FlowGramAPIName.TaskRun](
    input: TaskRunInput
  ): Promise<TaskRunOutput | undefined> {
    return this.request<TaskRunOutput>(
      TaskRunDefine.path,
      TaskRunDefine.method,
      {
        body: input,
  ...
  public async [FlowGramAPIName.TaskReport](
    ...
    return this.request<TaskReportOutput>(
      TaskReportDefine.path,
      TaskReportDefine.method,
      {
  ...
  public async [FlowGramAPIName.TaskResult](
    ...
    return this.request<TaskResultOutput>(
      TaskResultDefine.path,
      TaskResultDefine.method,
      {
        queryParams: { taskID: input.taskID },
  ...
  public async [FlowGramAPIName.TaskCancel](
  ...
  public async [FlowGramAPIName.TaskValidate](
    ...
    return this.request<TaskValidateOutput>(
      TaskValidateDefine.path,
      TaskValidateDefine.method,
      {
        body: input,
