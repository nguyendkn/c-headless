...
import { IconSuccessFill, IconWarningFill } from '@/components/icons';
...
export const NodeStatusRender: FC<NodeStatusRenderProps> = ({ report }) => {
  ...
  const renderIcon = () => {
    if (isNodeProcessing) {
      return <IconSpin spin className={cn(styles.icon, styles.processing)} />;
    }
    if (isNodeSucceed) {
      return <IconSuccessFill />;
    }
    return <IconWarningFill className={cn(tagColor, styles.round)} />;
  };
  const renderDesc = () => {
    const getDesc = () => {
      if (isNodeProcessing) {
      ...
      <>
        ...
        <div className={styles.snapshotNavigation}>
          ...
          <Select
            ...
            className={cn(styles.snapshotSelect, {
